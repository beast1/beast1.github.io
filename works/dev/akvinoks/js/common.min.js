...
pageHeader.dynamicThemeElements = pageHeader.root.querySelectorAll('.page-header__dynamic-theme');
...
function initFullScreen() {
  var elems = document.querySelectorAll('.fullscreen-element:not(.fullscreen-element_light)');
  var elemsLight = document.querySelectorAll('.fullscreen-element.fullscreen-element_light');
  if (elems) {
