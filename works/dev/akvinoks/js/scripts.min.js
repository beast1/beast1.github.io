...
var index = {
  freemodeBreakpoint: 768
}
function initMap() {
  var uluru = {lat: 59.9972123, lng: 30.2689611};
...
function initSwipers() {
  ...
  function initSwiperProjectsPagination () {
    var swiperProjectsIndexOutput = document.querySelector('#projects .slider-controls__pages-current');
    swiperProjects.on('slideChange', function () {
      swiperProjectsIndexOutput.textContent = '0' + (swiperProjects.activeIndex + 1);
    });
  }

  function initSwiperRootMenu () {
    var swiperRootMenuItems = document.querySelectorAll('.page-nav-item');
    for (var i = 0; i < swiperRootMenuItems.length; i++) {
      var swiperRootMenuItem = swiperRootMenuItems[i];
