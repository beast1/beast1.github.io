...
(function () {
  var controller = new ScrollMagic.Controller(); //установить максимальную высоту для .js-progress-bar
  ...
  var initStep = function initStep(number) {
    ...
    .addTo(controller).on("enter", function (e) {
      $("#roadmap-step-" + number).addClass("roadmap-step--active"); // $("#roadmap-step-" + number).addClass("tilt-in-bottom-1");
    }).reverse(false);
  };

  var initCheckpoint = function initCheckpoint(step, number, isLast) {
